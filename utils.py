...
MODEL_CLASSES = {
    ...
    'kcelectra-base': (ElectraConfig, ElectraForSequenceClassification, ElectraTokenizer),
    'kcbert-base' :(BertConfig,BertForSequenceClassification,BertTokenizer),
    'kpfbert':(BertConfig,BertForSequenceClassification,BertTokenizer),
    'klue-bert-base':(BertConfig,BertForSequenceClassification,BertTokenizer),
}
...
MODEL_PATH_MAP = {
    ...
    'kcelectra-base': 'beomi/KcELECTRA-base',
    'kcbert-base': 'beomi/kcbert-base',
    'kpfbert': 'jinmang2/kpfbert',
