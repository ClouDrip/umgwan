...
def main(args):
    init_logger()
    set_seed(args)
    wandb.init(project="cloudrip", entity="powerwook", config=args, name="klue-bert-base")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_dir", default="./model/klue-bert-base", type=str, help="Path to save, load model")
    parser.add_argument("--data_dir", default="./data", type=str, help="The input data dir")
    parser.add_argument("--train_file", default="train_data.tsv", type=str, help="Train file")
    parser.add_argument("--test_file", default="test_data.tsv", type=str, help="Test file")

    parser.add_argument("--model_type", default="klue-bert-base", type=str, help="Model type selected in the list: " + ", ".join(MODEL_CLASSES.keys()))
